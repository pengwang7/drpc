...
PROTOBUF_NAMESPACE_OPEN
template<> ::drpc::RpcMessage* Arena::CreateMaybeMessage<::drpc::RpcMessage>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace drpc {
...
constexpr MessageType MessageType_MAX = UNKNOW;
...
class RpcMessage PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:drpc.RpcMessage) */ {
 public:
  ...
  // .drpc.MessageType type = 1;
  void clear_type();
  ::drpc::MessageType type() const;
  void set_type(::drpc::MessageType value);
  private:
  ::drpc::MessageType _internal_type() const;
...
inline ::drpc::MessageType RpcMessage::_internal_type() const {
  return static_cast< ::drpc::MessageType >(type_);
}
inline ::drpc::MessageType RpcMessage::type() const {
  // @@protoc_insertion_point(field_get:drpc.RpcMessage.type)
  return _internal_type();
}
inline void RpcMessage::_internal_set_type(::drpc::MessageType value) {
  
  type_ = value;
}
inline void RpcMessage::set_type(::drpc::MessageType value) {
  _internal_set_type(value);
  // @@protoc_insertion_point(field_set:drpc.RpcMessage.type)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 RpcMessage::id() const {
  // @@protoc_insertion_point(field_get:drpc.RpcMessage.id)
  return _internal_id();
}
...
inline void RpcMessage::set_id(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  ...
  // @@protoc_insertion_point(field_set:drpc.RpcMessage.id)
}
...
inline const std::string& RpcMessage::service() const {
  // @@protoc_insertion_point(field_get:drpc.RpcMessage.service)
  return _internal_service();
}
inline void RpcMessage::set_service(const std::string& value) {
  _internal_set_service(value);
  // @@protoc_insertion_point(field_set:drpc.RpcMessage.service)
}
inline std::string* RpcMessage::mutable_service() {
  // @@protoc_insertion_point(field_mutable:drpc.RpcMessage.service)
...
inline void RpcMessage::set_service(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:drpc.RpcMessage.service)
}
inline void RpcMessage::set_service(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:drpc.RpcMessage.service)
}
inline void RpcMessage::set_service(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:drpc.RpcMessage.service)
}
...
inline std::string* RpcMessage::release_service() {
  // @@protoc_insertion_point(field_release:drpc.RpcMessage.service)
...
inline void RpcMessage::set_allocated_service(std::string* service) {
  ...
  service_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), service,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:drpc.RpcMessage.service)
}
...
inline const std::string& RpcMessage::method() const {
  // @@protoc_insertion_point(field_get:drpc.RpcMessage.method)
  return _internal_method();
}
inline void RpcMessage::set_method(const std::string& value) {
  _internal_set_method(value);
  // @@protoc_insertion_point(field_set:drpc.RpcMessage.method)
}
inline std::string* RpcMessage::mutable_method() {
  // @@protoc_insertion_point(field_mutable:drpc.RpcMessage.method)
...
inline void RpcMessage::set_method(std::string&& value) {
  ...
  method_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:drpc.RpcMessage.method)
}
inline void RpcMessage::set_method(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:drpc.RpcMessage.method)
}
inline void RpcMessage::set_method(const char* value,
    size_t size) {
  ...
  method_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:drpc.RpcMessage.method)
}
...
inline std::string* RpcMessage::release_method() {
  // @@protoc_insertion_point(field_release:drpc.RpcMessage.method)
...
inline void RpcMessage::set_allocated_method(std::string* method) {
  ...
  method_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), method,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:drpc.RpcMessage.method)
}
...
inline const std::string& RpcMessage::request() const {
  // @@protoc_insertion_point(field_get:drpc.RpcMessage.request)
  return _internal_request();
}
inline void RpcMessage::set_request(const std::string& value) {
  _internal_set_request(value);
  // @@protoc_insertion_point(field_set:drpc.RpcMessage.request)
}
inline std::string* RpcMessage::mutable_request() {
  // @@protoc_insertion_point(field_mutable:drpc.RpcMessage.request)
...
inline void RpcMessage::set_request(std::string&& value) {
  ...
  request_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:drpc.RpcMessage.request)
}
inline void RpcMessage::set_request(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:drpc.RpcMessage.request)
}
inline void RpcMessage::set_request(const void* value,
  ...
  request_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:drpc.RpcMessage.request)
}
...
inline std::string* RpcMessage::release_request() {
  // @@protoc_insertion_point(field_release:drpc.RpcMessage.request)
...
inline void RpcMessage::set_allocated_request(std::string* request) {
  ...
  request_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), request,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:drpc.RpcMessage.request)
}
...
inline const std::string& RpcMessage::response() const {
  // @@protoc_insertion_point(field_get:drpc.RpcMessage.response)
  return _internal_response();
}
inline void RpcMessage::set_response(const std::string& value) {
  _internal_set_response(value);
  // @@protoc_insertion_point(field_set:drpc.RpcMessage.response)
}
inline std::string* RpcMessage::mutable_response() {
  // @@protoc_insertion_point(field_mutable:drpc.RpcMessage.response)
...
inline void RpcMessage::set_response(std::string&& value) {
  ...
  response_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:drpc.RpcMessage.response)
}
inline void RpcMessage::set_response(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:drpc.RpcMessage.response)
}
inline void RpcMessage::set_response(const void* value,
  ...
  response_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:drpc.RpcMessage.response)
}
...
inline std::string* RpcMessage::release_response() {
  // @@protoc_insertion_point(field_release:drpc.RpcMessage.response)
...
template <> struct is_proto_enum< ::drpc::MessageType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::drpc::MessageType>() {
  return ::drpc::MessageType_descriptor();
}
template <> struct is_proto_enum< ::drpc::ErrorCode> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::drpc::ErrorCode>() {
  return ::drpc::ErrorCode_descriptor();
}
